...
defaultproperties
{
     ...
     FireModeClass(0)=Class'DEKWeapons209E.PlasmaGrenadeFire'
     FireModeClass(1)=Class'DEKWeapons209E.PlasmaGrenadeAltFire'
     PutDownAnim="PutDown"
     ...
     InventoryGroup=3
     GroupOffset=1
     //PickupClass=Class'DEKWeapons209E.PlasmaGrenadePickup'
