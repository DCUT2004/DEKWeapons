...
defaultproperties
{
     ...
     FireModeClass(0)=Class'DEKWeapons209C.PlasmaGrenadeFire'
     FireModeClass(1)=Class'DEKWeapons209C.PlasmaGrenadeAltFire'
     PutDownAnim="PutDown"
     ...
     InventoryGroup=3
     GroupOffset=1
     //PickupClass=Class'DEKWeapons209C.PlasmaGrenadePickup'
