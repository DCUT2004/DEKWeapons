...
defaultproperties
{
     ...
     FireModeClass(0)=Class'DEKWeapons999X.PlasmaGrenadeFire'
     FireModeClass(1)=Class'DEKWeapons999X.PlasmaGrenadeAltFire'
     PutDownAnim="PutDown"
     ...
     InventoryGroup=3
     GroupOffset=1
     //PickupClass=Class'DEKWeapons999X.PlasmaGrenadePickup'
