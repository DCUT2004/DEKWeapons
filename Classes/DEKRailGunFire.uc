...
defaultproperties
{
     ...
     HitEmitterClass=Class'DEKWeapons209C.DEKRailGunBolt'
     SecHitEmitterClass=Class'DEKWeapons209C.DEKRailGunBoltChild'
     SecTraceDist=700.000000
     DamageTypeHeadShot=Class'DEKWeapons209C.DamTypeDEKRailGunHeadShot'
     DamageType=Class'DEKWeapons209C.DamTypeDEKRailGunShot'
     DamageMin=40
     DamageMax=120
     ...
     TweenTime=0.010000
     FireRate=0.914286
     AmmoClass=Class'DEKWeapons209C.DEKRailGunAmmo'
}
