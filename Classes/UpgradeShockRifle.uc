...
function float RangedAttackTime()
{
	...
	return FMin(2,0.3 + VSize(B.Enemy.Location - Instigator.Location)/class'DEKWeapons208AJ.UpgradeShockProjectile'.default.Speed);
}
...
function byte BestMode()
{
	...
	if ( B.Skill > 5 )
		MaxDist = 4 * class'DEKWeapons208AJ.UpgradeShockProjectile'.default.Speed;
	else
		MaxDist = 3 * class'DEKWeapons208AJ.UpgradeShockProjectile'.default.Speed;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'DEKWeapons208AJ.UpgradeShockBeamFire'
     FireModeClass(1)=Class'DEKWeapons208AJ.UpgradeShockProjFire'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
     ...
     InventoryGroup=4
     PickupClass=Class'DEKWeapons208AJ.UpgradeShockRiflePickup'
