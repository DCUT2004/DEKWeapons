...
function float RangedAttackTime()
{
	...
	return FMin(2,0.3 + VSize(B.Enemy.Location - Instigator.Location)/class'DEKWeapons999X.UpgradeShockProjectile'.default.Speed);
}
...
function byte BestMode()
{
	...
	if ( B.Skill > 5 )
		MaxDist = 4 * class'DEKWeapons999X.UpgradeShockProjectile'.default.Speed;
	else
		MaxDist = 3 * class'DEKWeapons999X.UpgradeShockProjectile'.default.Speed;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'DEKWeapons999X.UpgradeShockBeamFire'
     FireModeClass(1)=Class'DEKWeapons999X.UpgradeShockProjFire'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
     ...
     InventoryGroup=4
     PickupClass=Class'DEKWeapons999X.UpgradeShockRiflePickup'
